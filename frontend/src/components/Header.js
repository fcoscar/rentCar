  ...
  return (
    <header className='sticky top-0 z-50 bg-white '>
      ...
      {userInfo ? (
        ...
        <a href='/login'><button className='rounded-full py-2 px-3 text-xs uppercase font-bold tracking-wider border-gray-300 border-2' onClick={btnHandler}>Iniciar Sesion</button></a>
      </div>
      )
