...
function HomePage() {
  ...
  return (   
    <section className='pt-4 xl:mr-10'>
        <h2 className='text-4xl font-semibold px-4 ml-12 xl:ml-80 xl:pl-8'>Encuentra un vehiculo</h2>        
        ...
        {loading ? (
          ...
          <div className='grid sm:grid-cols-2 lg:grid-cols-3 md:grid-cols-3 xl:grid-cols-4 xl:pl-72 xl:pr-72 ml-10 mr-14'>
          {cars[0]?.map((car, i) => 
